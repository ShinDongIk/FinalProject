		            ...
		            <c:forEach var="p" items="${list}">
			            <div class="itemRow">
			                ...
			                <div class="itemMembers">
			                	<c:forEach begin="1" end="${ p.partyCount }">
...
<!-- 			                    <span class="material-symbols-outlined" style="color: #a8b0ff;">person</span> -->
			                ...
			                <div class="itemJoin" style="float: right;">
       			            	<input type="hidden" value=${ p.partyNo } id="pno">
			                    <button type="button" class="button-deepPurple" id="btnJoin" onclick="location.href='partyjoin.pa?pno=${ p.partyNo }'">파티가입</button>
			                </div>
			            </div>
		            </c:forEach>
        		</c:otherwise>
