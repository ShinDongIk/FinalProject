		...
		<form action="" onsubmit="return false;" method="post">
			<table id="rp-enroll-table">
					...
					<tr>
						<th>월 요금</th>
						<td style="padding:0px">
							<input type="text" name="mothPrice" value="4800" placeholder="숫자만 입력해주세요!">
						</td>
					</tr>
					<tr>
						<th>연 요금</th>
						<td style="padding:0px">
							<input type="text" name="yearPrice" value="3800" placeholder="숫자만 입력해주세요!">
						</td>
					</tr>
					<tr>
						<th>동시 접속자</th>
						<td style="padding:0px">
							<input type="text" name="ConcurrentUsers" value="4" placeholder="숫자만 입력해주세요!">
						</td>
					</tr>
					<tr>
						<th>프로필수</th>
						<td style="padding:0px">
							<input type="text" name="profilesNum" value="4" placeholder="숫자만 입력해주세요!">
						</td>
					</tr>
					<tr>
						<th rowspan="2" >최대 화질</th>
						<td style="padding:0px">
							<input id="quality-id" type="text" name="quality" value="4" placeholder="해상도를 입력해주세요!">
