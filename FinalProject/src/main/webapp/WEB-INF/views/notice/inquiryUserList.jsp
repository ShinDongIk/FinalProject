...
<body>
    ...
    <div id="content" align="center">
        ...
        <form action="inquiryUserSearch.in">
    		...
    		<input type="text" name="keyword" style="width: 30%; display: inline;">&nbsp<button type="submit">검색</button>
    ...
    <div id="paging-area" align="center">
    	<c:choose>
    		...
    		<c:otherwise>
    			<button onclick="location.href='inquiryUserList.in?cPage=${pi.currentPage - 1}&userId=${loginUser.userId }'"><</button>
    		</c:otherwise>
    	</c:choose>
    	...
    	<c:forEach var="p" begin="${pi.startPage }" end="${pi.endPage }">
	    	<c:choose>
	    		...
	    		<c:otherwise>
	    			<button onclick="location.href='inquiryUserList.in?cPage=${p}&userId=${loginUser.userId }'" >${p }</button>
	    		</c:otherwise>
	    	</c:choose>
    	</c:forEach>
