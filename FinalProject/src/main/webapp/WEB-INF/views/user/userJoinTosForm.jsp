...
<script src="https://static.nid.naver.com/js/naveridlogin_js_sdk_2.0.2.js" charset="utf-8"></script>
    ...
    <div class="outer">
		...
		<div class="content2">
       		<form action="joinForm.me" id="joinForm" method="post">
       			<div class="subTitle">
	                <b class="font-purple">ENJOY OTT </b><b>회원가입</b>
	            </div>
	            <br>
	            <div class="check">
	                <input type="checkbox" id="checkAll" style="font-size:13px"> <label for="checkAll"> 전체동의</label><br>
	            </div>
	            <br>
		            
	            <div class="subTitle">
	                <b style="font-size:16px">이용약관 동의</b>
	            </div>
...
이 약관은 전자상거래(인터넷사이버몰) 표준약관 제10023호(2014. 9. 19. 개정)를 준수합니다.
		        ...
		        <div class="check">
		            <input type="checkbox" id="check1" name="chk"> <label for="check1"> 이용약관 동의</label><br>
		        </div>
		      	<br>
			        
			    <div class="subTitle">
		            <b style="font-size:16px">개인정보 처리방침 동의</b>
		        </div>
...
본 방침은 2019년 10월 16일부터 시행합니다.
			    ...
			    <div class="check">
			        <input type="checkbox" id="check2" name="chk"> <label for="check2"> 개인정보 처리방침 동의</label><br>
			    </div><br><br>
